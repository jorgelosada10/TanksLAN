...
namespace Complete
{
    public class TankShooting : NetworkBehaviour
    {
        ...
        public Rigidbody m_Shell_bomb;                   // Prefab of the shell
        ...
        private void CmdFire()
        {
            ...
            if(metralla){
                ...
                shellInstance = Instantiate(m_Shell_bomb, m_FireTransform.position, m_FireTransform.rotation) as Rigidbody;
